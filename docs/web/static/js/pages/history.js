  ...
  function renderItems(items) {
    ...
    items.forEach(function(item) {
      ...
      var imgHtml = item.image_url
        ? '<img class="hi-thumb" src="' + escapeAttr(item.image_url) + '" alt="" loading="lazy" referrerpolicy="no-referrer">'
    ...
    // 图片加载失败时隐藏（替代内联 onerror）
    var imgs = historyList.querySelectorAll('.hi-thumb');
